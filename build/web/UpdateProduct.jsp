<%-- 
    ...
    Created on : 05-07-2024, 18:03:21
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="form-container">
            <form action="UpdateProductController" method="post" class="form">
                <label for="productId">ProductID</label><br>
                <input type="text" id="productId" name="txtProductID" value="${ProductID}" readonly="true"><br>
                <label for="productName">ProductName</label><br>
                <input type="text" id="productName" name="txtProductName"><br>
                ...
                <input class="button" type="submit" value="Save" name="action" /><br>
            </form>
        </div>
        <%
