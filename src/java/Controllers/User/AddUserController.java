...
public class AddUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            AccountID = "acc" + String.format("%03d", Integer.parseInt(accountDAO.getLastAccount().getAccountID().replaceAll("[^0-9]", "")) + 1);   
            ...
            if(Password.equals(repeatPassword)){
                ...
                message = "Repeat Password does not match Password, Please try again!";
            }
        }catch(Exception ex){
            log(ex.getMessage());
        }finally{
